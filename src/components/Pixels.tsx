...
/**
 * Pixels publicitaires (Meta + TikTok), pilotés depuis le super admin.
 * Rien n'est injecté tant que l'ID n'est pas renseigné (vie privée + pas de
 * script inutile). PageView est suivi automatiquement ; l'achat est envoyé par
 * <PixelPurchase> sur la page de confirmation.
 */
export default function Pixels({ fb, tiktok }: { fb?: string; tiktok?: string }) {
  return (
    <>
      {fb && (
